...
" au FileType go InsertLeave go GoFmt
" au FileType go nmap ' <Plug>(go-run)
" au FileType go nmap " :GoMetaLinter<enter>
" au FileType go nmap ^ :GoDescribe<enter>
" au FileType go nmap <leader>e xierr<esc>oif err != nil {<enter>
...
"hi LineNr guifg=#f3fcd4 guibg=#9db846
"hi CursorLine cterm=NONE ctermbg=228
"hi CursorLineNR guifg=black guibg=#f7f783
...
" autocmd VimEnter * call timer_start(200, { tid -> execute('hi StatusLineNC guifg=#f0e7d1 guifg=#c2af8f cterm=none gui=none')})
autocmd VimEnter * call timer_start(200, { tid -> execute('hi LineNr guifg=#d6ae65 guibg=#ffedcc')})
...
" 
" :autocmd BufWritePost * !silent ./autoload.sh testprog
" set autowrite
nmap H gg=G<C-o><C-o>;
